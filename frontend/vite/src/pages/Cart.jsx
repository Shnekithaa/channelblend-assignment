    ...
    <div>
      <div className='max-w-7xl mx-auto my-10 p-4'>
        ...
        {getTotalCartItems() === 0 ? (
          ...
          <div>
            {/* Cart Table Header */}
            <div className='grid grid-cols-6 md:grid-cols-[0.5fr,2fr,1fr,1fr,1fr,1fr] items-center px-4 font-semibold text-gray-800'>
              <p>Product</p>
              <p>Title</p>
            ...
            {all_product.map((e) => {
              if (cartItems[e.id] > 0) {
                return (
                  <div key={e.id}>
                    <div className='text-gray-500 font-semibold text-sm sm:text-base grid grid-cols-6 md:grid-cols-[0.5fr,2fr,1fr,1fr,1fr,1fr] items-center px-4 gap-2'>
